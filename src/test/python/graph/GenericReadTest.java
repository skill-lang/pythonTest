...
from graph.api.SkillFile import SkillFile
...
class GenericReadTest(CommonTest, Testcase):
    ...
    def test_graph_read_reject_duplicateDefinitionMixed_sf(self):
        try:
    ...
    def test_graph_read_reject_duplicateDefinitionSecondBlock_sf(self):
        try:
    ...
    def test_graph_read_reject_illegalStringPoolOffsets_sf(self):
        try:
    ...
    def test_graph_read_reject_illegalTypeID_sf(self):
        try:
    ...
    def test_graph_read_reject_missingUserType_sf(self):
        try:
    ...
    def test_graph_read_reject_nullAsFieldName_sf(self):
        try:
    ...
    def test_graph_read_reject_nullInNonNullNode_sf(self):
        try:
