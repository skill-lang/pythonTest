...
from restrictionsAll.api.SkillFile import SkillFile
...
class GenericReadTest(CommonTest, Testcase):
    ...
    def test_restrictionsAll_read_accept_age_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/age.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_age16_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/age16.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_ageUnrestricted_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/ageUnrestricted.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_aircraft_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/aircraft.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_annotationNull_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/annotationNull.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_annotationString_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/annotationString.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_annotationTest_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/annotationTest.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_coloredNodes_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/coloredNodes.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_container_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/container.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_crossNodes_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/crossNodes.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_date_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/date.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_emptyBlocks_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/emptyBlocks.sf")
            self.assertIsNotNone(sf)
    ...
    def test_restrictionsAll_read_accept_fourColoredNodes_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/fourColoredNodes.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_localBasePoolOffset_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/localBasePoolOffset.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_noFieldRegressionTest_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/noFieldRegressionTest.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_nodeFirstBlockOnly_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/nodeFirstBlockOnly.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_restrictionsAll_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/restrictionsAll.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_trivialType_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/trivialType.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_twoNodeBlocks_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/twoNodeBlocks.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_twoTypes_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/twoTypes.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_accept_unicode_reference_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/accept/unicode-reference.sf")
            self.assertIsNotNone(sf)

    def test_restrictionsAll_read_reject_duplicateDefinition_sf(self):
        try:
    ...
    def test_restrictionsAll_read_reject_duplicateDefinitionMixed_sf(self):
        try:
    ...
    def test_restrictionsAll_read_reject_duplicateDefinitionSecondBlock_sf(self):
        try:
    ...
    def test_restrictionsAll_read_reject_illegalStringPoolOffsets_sf(self):
        try:
    ...
    def test_restrictionsAll_read_reject_illegalTypeID_sf(self):
        try:
    ...
    def test_restrictionsAll_read_reject_missingUserType_sf(self):
        try:
    ...
    def test_restrictionsAll_read_reject_nullAsFieldName_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/fail/nullAsFieldName.sf")
            ForceLazyFields.forceFullCheck(sf);
            Assert.fail("Expected ParseException to be thrown");
        except SkillException:
            # success

    def test_restrictionsAll_read_reject_nullInNonNullNode_sf(self):
        try:
            sf = read("src/test/resources/genbinary/restrictionsAll/fail/nullInNonNullNode.sf")
            ForceLazyFields.forceFullCheck(sf);
            Assert.fail("Expected ParseException to be thrown");
        except SkillException:
            # success
