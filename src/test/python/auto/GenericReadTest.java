...
from auto.api.SkillFile import SkillFile
...
class GenericReadTest(CommonTest, Testcase):
    ...
    def test_auto_read_accept_age_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/age.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_ageUnrestricted_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/ageUnrestricted.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_coloredNodes_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/coloredNodes.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_crossNodes_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/crossNodes.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_date_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/date.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_emptyBlocks_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/emptyBlocks.sf")
            self.assertIsNotNone(sf)
    ...
    def test_auto_read_accept_noFieldRegressionTest_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/noFieldRegressionTest.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_nodeFirstBlockOnly_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/nodeFirstBlockOnly.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_trivialType_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/trivialType.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_twoNodeBlocks_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/twoNodeBlocks.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_accept_unicode_reference_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/accept/unicode-reference.sf")
            self.assertIsNotNone(sf)

    def test_auto_read_reject_duplicateDefinition_sf(self):
        try:
    ...
    def test_auto_read_reject_duplicateDefinitionMixed_sf(self):
        try:
    ...
    def test_auto_read_reject_duplicateDefinitionSecondBlock_sf(self):
        try:
    ...
    def test_auto_read_reject_illegalStringPoolOffsets_sf(self):
        try:
    ...
    def test_auto_read_reject_illegalTypeID_sf(self):
        try:
    ...
    def test_auto_read_reject_localBasePoolOffset_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/fail/localBasePoolOffset.sf")
            ForceLazyFields.forceFullCheck(sf);
            Assert.fail("Expected ParseException to be thrown");
        except SkillException:
            # success

    def test_auto_read_reject_missingUserType_sf(self):
        try:
    ...
    def test_auto_read_reject_twoTypes_sf(self):
        try:
            sf = read("src/test/resources/genbinary/auto/fail/twoTypes.sf")
            ForceLazyFields.forceFullCheck(sf);
            Assert.fail("Expected ParseException to be thrown");
        except SkillException:
            # success
